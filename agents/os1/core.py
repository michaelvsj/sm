...
from agents.os1.utils import build_trig_table


class OS1ConfigurationError(Exception):
    pass

IMU_FREQUENCY = 100 #Hz. Frecuencia de salida de datos de IMU

class OS1(object):
    MODES = ("512x10", "512x20", "1024x10", "1024x20", "2048x10")

    def __init__(self, sensor_ip, dest_ip, udp_port=7502, tcp_port=7501, mode="512x10"):
